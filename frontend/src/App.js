  ...
  const menuItems = [
    {
      key: '/',
      icon: <RobotOutlined />,
      label: <Link to="/">Чат с AI</Link>,
    },
    {
      key: '/search',
      icon: <SearchOutlined />,
      label: <Link to="/search">Поиск компании</Link>,
    },
    {
      key: '/equipment',
    ...
    },
    {
      ...
      label: <Link to="/settings">Настройки диалогов</Link>,
    },
    {
      key: '/upload',
      icon: <UploadOutlined />,
